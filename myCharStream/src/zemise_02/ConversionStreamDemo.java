...
public class ConversionStreamDemo {
    public static void main(String[] args) throws IOException {
        //OutputStreamWriter (OutputStreamOut）创建一个使用默认字符编码的OutputStreamWriter.
        //OutputStreamWriter (OutputStreamOut, String charsetName）创建一个使用命名字符集的OutputStreamWriter.
